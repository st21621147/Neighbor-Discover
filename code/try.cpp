...
const int SCOPE = 100;
const int N = 100;//the number of nodes 
...
//				for(int j = 0; j < N; j++){
//					if(latencyMap[i][j] == -1 && nodelist[j].state == 1){
...
//	cout<<un<<endl;
//	cout<<ave<<endl;
//	cout<<"discovery rate:"<<(N-un)/N<<endl;
//	cout<<"average latency"<<ave/(N-un)<<endl; 
//}
