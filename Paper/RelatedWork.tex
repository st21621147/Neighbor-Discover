...
Under this assumption, the listening time slot is much larger than the transmitting time slot, which makes a complete sot 
is 40 times than that of U-Connect~\cite{kandhalu2010u} and thus result in high latency.
