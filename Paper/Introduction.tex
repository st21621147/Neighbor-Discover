...
% P4:
% What is a practical network model and define what is partially-connected networks.
...
% P5: 
% What issues will occur, if transferring the existing methods (mentioned in P2) to the practical network model
...
% P6: 
% Summarize and highlight the crucial issue
