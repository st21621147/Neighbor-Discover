...
\item[3)] We conduct experiments for fundamental observation and extensive simulations for large-scale networks.  Alano achieves lower latency, higher discovery rate, and better scalability.%, and robustness compared with the state-of-the-art algorithms. 
\end{itemize}
%\fi
