...
That is, these algorithms could not achieve low latency and energy efficiency at the same time since they failed to deal with collisions effectively. %Such failure also costed time and energy. 
