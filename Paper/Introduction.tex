...
Collisions of searchlight \cite{bakht2012searchlight} and PND \cite{song2014probabilistic} happen as frequently as 99.8\% and 43.4\% respectively. Aloha-like \cite{you2011aloha} and PND \cite{song2014probabilistic} show a high idle rate (none of the neighbors are transmitting) as 94.6\% and XX\% of the time, which reduce the collisions excessively.  %and still results in a high latency. %This is the same with CSMA \cite{bianchi1996performance}, a general collision avoidance  technique in networks, the idle rate of which is XX\% by simulations. 
