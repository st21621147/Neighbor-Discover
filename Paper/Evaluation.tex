...
In Fig. \ref{fig_latency}, when nodes follow uniform distribution, Alano has $54.64\%$ to $1.95$ times lower latency with gloabal duty cycle, and $85.25\%$ to $2.91$ times lower latency with local duty cycle. 
...
In reality, nodes die now and then, and it is important for neighbor discovery protocols to remain good performance when nodes die. Fig. \ref{fig_robust} shows that when $5\%$ to $30\%$ nodes die, Alano still reach low latency robustly.
