...
There is a detail to be noticed when regarding the whole period $T$ as a time slot in Alg. \ref{Alano}. 
...
\begin{IEEEproof}
We first prove that any pair of nodes (node $i$, node $j$) wake up 
